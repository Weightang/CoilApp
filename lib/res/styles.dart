...
class Decorations {
  static Decoration bottom = BoxDecoration(
      border: Border(bottom: BorderSide(width: 0.33, color: MyColors.divider)));

  static Decoration topBottom = BoxDecoration(
      border: Border(
          bottom: BorderSide(width: 1, color: MyColors.grey_ec),
          top: BorderSide(width: 1, color: MyColors.grey_ec)));
}
